...
class Admin {
    ...
    public function admin_menu() {
        ...
        $hook = add_menu_page( __( 'Svelte App', 'textdomain' ), __( 'Svelte App', 'textdomain' ), $capability, $slug, [ $this, 'plugin_page' ], 'dashicons-text' );
    ...
    public function plugin_page() {
        echo '<div class="wrap"><div id="svelte-admin-app"></div></div>';
    }
}
